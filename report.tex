...
\begin{flushleft}
    ...
    \begin{center}
        ...
        \begin{tabularx}{\linewidth}{ | c | Y | X | }
            ...
            \hline
            \texttt{scripts/poincare.py} & Computes statistics for the $L$ Poincare section (described later in this report) & \\
            \hline
    ...
    \begin{figure}[h]
        ...
        \captionsetup{width=0.8\linewidth}
        \ccaption{Bifurcation diagram with $\phi = 0.04$ fixed and $I$ varied. The value of $v$ at the fixed point, as well as extremal values of $v$ along the stable (SLC) and unstable (ULC) limit cycles are tracked.}
